...
export default {
  ...
  setup() {
    ...
    const columnDefs = reactive({
      value: [
               ...
               { minWidth:400,field: 'disc', headerName: 'Дисциплина'},
               { maxWidth:150,field: 'number_of_subgroups', headerName: 'Подгруппы'},
               { minWidth:300,field: 'fio',headerName: 'ФИО'},
               { minWidth:300,field: 'display_audit',headerName: 'Дисплейный класс'}
  ...
  methods: {
      ...
      async loadTempKIT() {
        try {
          const response = await UserService.getForShedPrac(); // Replace with your API endpoint
