<template>
    ...
    <div class="col col-xs- col-lg-12 mt-4 list">
      <div class="col col-12">
      <div class="mb-3 col col-12 ">
      
        <div class="d-inline-flex">
            <h1>Список преподавателей ФКТиПМ</h1>
        </div>
  ...
  import ButtonCell from "@/components/TeacherButtonCell.vue";
  import TeacherHref from "@/components/TeacherHrefCellRenderer.vue";
  ...
  export default {
    ...
    setup() {
      ...
      const columnDefs = reactive({
        ...
        maxWidth: 120, resizable: false
             ...
             { field: "full_name", headerName: 'ФИО', cellRenderer: "TeacherHref" }
    ...
    methods: {
      ...
      async loadTeachersData() {
          try {
            const response = await UserService.getTeachersAsIdText(); // Replace with your API endpoint
