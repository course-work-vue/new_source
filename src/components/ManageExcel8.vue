...
export default {
  ...
  setup() {
    ...
    const columnDefs = reactive({
      value: [
               ...
               { maxWidth:150,field: 'number_of_streams', headerName: 'Потоки'},
               { maxWidth:150,field: 'number_of_groups', headerName: 'Группы'},
  ...
  methods: {
      ...
      async loadTempKIT() {
        try {
          const response = await UserService.getForShedLec(); // Replace with your API endpoint
