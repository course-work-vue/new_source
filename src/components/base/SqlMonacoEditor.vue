  ...
  <div class="monaco-editor-wrapper">
    ...
    <div class="editor-toolbar" v-if="!loading && showToolbar">
      <button
        ...
        @click="toggleTheme"
        :title="
          currentTheme.startsWith('pgsql-dark')
      ...
      >
        <i
          :class="
            currentTheme.startsWith('pgsql-dark') ? 'pi pi-sun' : 'pi pi-moon'
          "
        ></i>
      </button>
    </div>
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const toggleTheme = () => {
      const newTheme =
        currentTheme.value === "pgsql-dark" ? "pgsql-light" : "pgsql-dark";
    ...
    onMounted(() => {
      ...
      editor = monaco.editor.create(editorContainer.value, {
        ...
        formatOnType: false,
        tabSize: 2,
        acceptSuggestionOnEnter: "on", // всегда принимать по Enter
        //acceptSuggestionOnTab: true, // принимать по Tab
        //tabCompletion: "on", // включить таб-автодополнение
        //snippetSuggestions: "inline", // (опционально) показывать сниппеты среди прочих
      });
