...
export default class Listenergroup {
  ...
  constructor(listenergroup) {
    ...
    this.start_date = listenergroup?.start_date ? new Date(listenergroup.start_date) : null;
    this.end_date = listenergroup?.end_date ? new Date(listenergroup.end_date) : null;
