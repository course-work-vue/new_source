...
export default class Listener_Wish {
  ...
  constructor(listener_wish) {
    ...
    this.start_date = listener_wish?.start_date ? new Date(listener_wish.start_date) : null;
    this.end_date = listener_wish?.end_date ? new Date(listener_wish.end_date) : null;
